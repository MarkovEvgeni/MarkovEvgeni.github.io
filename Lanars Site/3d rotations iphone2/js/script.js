$(function () {
    ...
    function rotate() {
        rotatedObject.css({
                transform: 'rotateY(-30deg) rotateX(70deg)  translateZ(-124px)',
                MozTransform: 'rotateY(-30deg) rotateX(70deg)  translateZ(-124px)',
                WebkitTransform: 'rotateY(-30deg) rotateX(70deg)  translateZ(-124px)',
                msTransform: 'rotateY(-30deg) rotateX(70deg)  translateZ(-124px)',
