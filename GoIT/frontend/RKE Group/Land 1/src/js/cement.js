document.addEventListener('DOMContentLoaded', function () {
    ...
    function cementMenu () {
        ...
        mainMenu.style.backgroundColor = 'rgba(0,0,0,1)';
        mainMenu.style.width = '100%';
        mainMenu.style.left = '0px';
        mainMenu.style.top = '0px';
    };
    
    function unCementMenu () {
        mainMenu.style.backgroundColor = 'rgba(0,0,0,.6)';
        mainMenu.style.position = 'relative';
    }
    
    function addHeaderPadding () {
        var phrase = document.getElementsByClassName('phrase')[0];
        var phraseStyle = getComputedStyle(phrase);
        var phraseStylePaddingBottom = parseInt(phraseStyle.paddingBottom) + mainMenu.offsetHeight + 'px';
        phrase.style.paddingBottom = phraseStylePaddingBottom;     
    }
    ...
    function watchMenu () {
        ...
        if (scrolled >= (headerHeight - mainMenuHeight)) {
    ...
    document.addEventListener("scroll", watchMenu);
